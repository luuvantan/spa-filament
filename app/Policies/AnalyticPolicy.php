...
class AnalyticPolicy
{
    ...
    {
        return $user->can('view_any_analytic');
    }
    ...
    {
        return $user->can('create_analytic');
    }
    ...
    {
        return $user->can('update_analytic');
    }
    ...
    {
        return $user->can('delete_analytic');
    }
    ...
    {
        return $user->can('delete_any_analytic');
    }
     ...
     */
    public function replicate(User $user, Analytic $analytic): bool
    {
