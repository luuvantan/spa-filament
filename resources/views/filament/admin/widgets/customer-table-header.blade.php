<x-filament-widgets::widget>
    <div class="space-y-4">
        ...
        <div class="flex flex-row gap-3 w-fit mx-auto">
            ...
            <div wire:click="loadCustomer('new_today')" class=" w-28 h-28 flex flex-col items-center justify-center p-3 bg-white rounded-xl shadow-sm border border-primary-600"
            ...
            <div wire:click="loadCustomer('today_birthdays')" class="w-28 h-28 flex flex-col items-center justify-center p-3 bg-white rounded-xl shadow-sm border border-primary-600"
            ...
            <div wire:click="loadCustomer('week_birthdays')" class="w-28 h-28 flex flex-col items-center justify-center p-3 bg-white rounded-xl shadow-sm border border-primary-600"
            ...
            <div wire:click="loadCustomer('month_birthdays')" class="w-28 h-28 flex flex-col items-center justify-center p-3 bg-white rounded-xl shadow-sm border border-primary-600"
